...
#SBATCH --output=mri-template-age16f-low-creation-%j.out
#SBATCH --error=mri-template-age16f-low-creation-%j.err
...
UNIQUE_TEMP_DIR=${TMPROOT:-/tmp}/TemplateCreationAge16Female_low
